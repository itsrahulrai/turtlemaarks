        ...
        <div class="col-lg-7">
            ...
            <div class="p-4 bg-white rounded-4 border">
                ...
                <div class="d-flex flex-column gap-3">
                    <label class="d-flex align-items-center gap-3 p-3 payment-option" style="cursor:pointer;">
                    ...
                    <label class="d-flex align-items-center gap-3 p-3 payment-option" style="cursor:pointer;">
                        ...
                        <div class="ms-auto fw-bold" style="color:var(--tm-orange);font-size:.85rem;">
