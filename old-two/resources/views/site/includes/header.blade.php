                       ...
                       <div class="container-wrapper">
                           <div class="row align-items-center">
                               <div class="col-lg-2 col-xl-2 col-md-3 col-4">
                                   <div class="logo">
                                       <a href="{{ route('home') }}"> <img src="{{ asset('frontend-assets/images/logo.png') }}" style="width:100px;" alt=""></a>
                                   </div>
                               </div>
                               <div class="col-lg-10 col-xl-10 col-md-9 col-8">
                                       ...
                                       <ul class="main-menu">
                                           ...
                                           <li>
                                               <a href="{{ route('cart.index') }}">
                                                   ...
                                                   <span id="cart-count" class="badge bg-danger" style="border-radius:50%;font-size:.65rem;{{ ($cartCount ?? 0) > 0 ? '' : 'display:none;' }}">{{ $cartCount ?? 0 }}</span>
                                               </a>
                                           </li>
                                           @auth
                                           <li><a href="{{ route('account.dashboard') }}"><i class="fas fa-user"></i> Profile</a></li>
                                           @else
