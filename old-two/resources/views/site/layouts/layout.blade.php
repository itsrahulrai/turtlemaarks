...
<body>
    ...
    <script>
        // Attach the CSRF token to every AJAX request so PATCH/DELETE/POST
        // calls (cart qty update, remove, coupon apply, wishlist toggle...)
        // don't get rejected with a 419 Page Expired error.
        $.ajaxSetup({
