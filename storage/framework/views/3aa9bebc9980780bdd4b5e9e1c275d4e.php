<?php $__env->startSection('title', 'Turtle Maarks Hearing Health — Modern Hearing Aids & Audiology Clinic'); ?>
<?php $__env->startSection('meta_description', 'Authorized clinic for Phonak, Oticon, ReSound, Signia, Starkey, Widex digital hearing aids & sound-booth diagnostic hearing tests in Greater Noida West & Noida.'); ?>
<?php $__env->startSection('active_nav', 'home'); ?>

<?php $__env->startSection('content'); ?>
<!-- ============ FULL-WIDTH HERO IMAGE BANNER ============ -->
  <!-- <section class="tm-hero-image-banner p-0 m-0 w-100">
    <a href="<?php echo e(route('appointments.create')); ?>" class="d-block w-100" title="Book Hearing Health Consultation">
      <picture class="w-100 d-block">
        <source media="(max-width: 767.98px)" srcset="<?php echo e(tm_asset('images/banners/mobile/mob-banner.png')); ?>">
        <img src="<?php echo e(tm_asset('images/banners/b7.png')); ?>" alt="Turtle Maarks Hearing Health — Authorized Clinic for Phonak, Oticon, ReSound, Signia, Starkey, Widex" class="w-100 d-block tm-hero-banner-img">
      </picture>
    </a>
  </section> -->
            ...
            <div class="carousel-inner">
                ...
                <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                        ...
                        <a href="<?php echo e($banner->link ?: route('appointments.create')); ?>"
                           class="d-block w-100"
                           title="<?php echo e($banner->title ?: 'Book Hearing Health Consultation'); ?>">
                            ...
                            <picture class="d-block w-100">
                                ...
                                <?php if(!empty($banner->mobile_image)): ?>
                                    <source
                                        ...
                                        srcset="<?php echo e(asset('/storage/' . $banner->mobile_image)); ?>">
                                <?php endif; ?>

                                
                                <img
                                    src="<?php echo e(asset('/storage/' . $banner->image)); ?>"
                                    alt="<?php echo e($banner->title ?: 'Turtle Maarks Hearing Health'); ?>"
        ...
        <a href="<?php echo e(route('appointments.create')); ?>"
           class="d-block w-100">
            ...
            <picture class="d-block w-100">
                ...
                <source
                    media="(max-width: 767.98px)"
                    srcset="<?php echo e(tm_asset('images/banners/mobile/mob-banner.png')); ?>">

                <img
                    src="<?php echo e(tm_asset('images/banners/b7.png')); ?>"
  ...
  <section class="py-5 bg-white">
    <div class="container">
      <div class="d-flex justify-content-between align-items-end tm-section-head mb-4">
        ...
        <a href="<?php echo e(route('products')); ?>" class="tm-btn tm-btn-outline-navy tm-btn-sm d-none d-sm-inline-flex">View All Models <i class="bi bi-arrow-right"></i></a>
      </div>
      ...
      <div class="row row-cols-2 row-cols-md-3 row-cols-lg-6 g-2 g-md-3">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $categories->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <?php
          ...
          ?>
          <div class="col">
            <a href="<?php echo e(route('products', ['category' => $category->slug])); ?>" class="tm-cat-card-lux tm-cat-theme-<?php echo e($theme); ?>">
              <span class="tm-cat-badge-top">
                <?php if($category->subcategories && $category->subcategories->isNotEmpty()): ?>
                  <?php echo e($category->subcategories->first()->name); ?>
              ...
              <div class="tm-cat-media-lux">
                <img src="<?php echo e($catImage); ?>" 
                     ...
                     onerror="this.onerror=null;this.src='<?php echo e(tm_asset('images/hearing-aid/ric.webp')); ?>';">
              </div>
              <div class="tm-cat-content-lux">
                <h6 class="tm-cat-title-lux"><?php echo e($category->name); ?></h6>
                <p class="tm-cat-desc-lux"><?php echo e(\Illuminate\Support\Str::limit($category->description ?: 'Explore genuine models with verified clinical warranty & trial', 70)); ?></p>
                <div class="tm-cat-footer-lux">
                  <span class="tm-cat-count-badge">
                    <?php if($subCount > 0): ?>
                      <?php echo e($subCount); ?> <?php echo e(\Illuminate\Support\Str::plural('Model', $subCount)); ?>
      ...
      <div class="text-center mt-3 d-sm-none">
        <a href="<?php echo e(route('products')); ?>" class="tm-btn tm-btn-outline-navy tm-btn-sm w-100">
  ...
  <section class="py-5 tm-popular-section-bg border-top border-bottom">
    <div class="container">
      ...
      <div class="tm-category-carousel-wrap mb-4">
        ...
        <div class="tm-filter-tabs-nav tm-category-tabs-strip" id="tmCategoryTabsStrip">
          ...
          <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <button class="tm-filter-tab-btn" data-tm-filter-tab="<?php echo e($cat->slug); ?>">
              <i class="bi <?php echo e($catIcon); ?>"></i> <?php echo e($cat->name); ?>
      ...
      <div id="tmInteractiveFeaturedGrid" data-tm-products="all" data-tm-limit="8" data-tm-col="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-3" class="row g-3">
        <?php echo $__env->make('site.partials.product-grid', ['products' => $popularProducts, 'col' => 'col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-3'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      </div>

      <div class="text-center mt-4">
        <a href="<?php echo e(route('products')); ?>" id="tmFeaturedViewAllBtn" class="tm-btn tm-btn-primary px-4 py-2">
  ...
  <section class="py-5 bg-white border-bottom">
    <div class="container">
      ...
      <div class="tm-brand-carousel-wrap mb-4">
        ...
        <div class="tm-brand-tabs-strip justify-content-lg-start" id="tmBrandTabsStrip">
          <div class="tm-brand-tab-card active"
               ...
               data-tm-brand-url="<?php echo e(route('products')); ?>"
          ...
          <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="tm-brand-tab-card"
                 data-tm-brand-tab="<?php echo e($brand->name); ?>"
                 data-tm-brand-origin="<?php echo e($origin); ?>"
                 data-tm-brand-usp="<?php echo e($usp); ?>"
                 data-tm-brand-url="<?php echo e(route('products', ['brand' => $brand->name])); ?>"
                 title="<?php echo e($brand->name); ?> Hearing Aids">
      ...
      <div class="tm-brand-hero-pill mb-4">
        ...
        <div>
          <a href="<?php echo e(route('products')); ?>" id="tmBrandViewAllBtn" class="tm-btn tm-btn-outline-navy btn-sm text-nowrap">
      ...
      <div id="tmBrandShowcaseGrid" data-tm-products="all" data-tm-limit="4" data-tm-col="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-3" class="row g-3">
        <?php echo $__env->make('site.partials.product-grid', ['products' => $brandProducts, 'col' => 'col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-3'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      </div>

      <!-- Advertisement Banner -->
      <div class="mt-4 pt-2">
        <a href="<?php echo e(route('appointments.create')); ?>" class="d-block overflow-hidden rounded-4 shadow-sm border tm-ad-banner-link" title="Book Free Consultation">
          <img src="<?php echo e(tm_asset('images/banners/adds.png')); ?>" alt="Turtle Maarks Hearing Health — Good Hearing, Stronger Connections" class="w-100 d-block tm-ad-banner-img" loading="lazy">
        </a>
      </div>
  ...
  <section class="py-5 bg-white tm-diagnostic-showcase-section border-top border-bottom" id="diagnosticHearingTests">
    <div class="container">
      ...
      <div class="d-flex justify-content-between align-items-end tm-section-head mb-4">
        ...
        <a href="<?php echo e(route('diagnostic-services')); ?>" class="tm-btn tm-btn-outline-navy tm-btn-sm d-none d-sm-inline-flex">All Tests <i class="bi bi-arrow-right ms-1"></i></a>
      </div>
      ...
      <div class="row row-cols-2 row-cols-md-2 row-cols-lg-4 g-2 g-md-4">
        ...
        <div class="col">
          <div class="tm-diag-service-card">
            <a href="<?php echo e(route('pta-pure-tone-audiometry')); ?>" class="d-block w-100 tm-diag-service-img-wrap" title="Pure Tone Audiometry (PTA)">
              <img src="<?php echo e(tm_asset('images/services/pta.webp')); ?>" alt="PTA Pure Tone Audiometry" class="tm-diag-service-img" loading="lazy">
            </a>
            <h3 class="tm-diag-service-title">
              <a href="<?php echo e(route('pta-pure-tone-audiometry')); ?>" class="text-decoration-none text-reset">PTA</a>
            </h3>
            <p class="tm-diag-service-desc">Pure Tone Audiometry (PTA) is a fundamental hearing test used to evaluate</p>
            <a href="<?php echo e(route('pta-pure-tone-audiometry')); ?>" class="tm-diag-service-link">
        ...
        <div class="col">
          <div class="tm-diag-service-card">
            <a href="<?php echo e(route('tymp-tympanometry')); ?>" class="d-block w-100 tm-diag-service-img-wrap" title="Tympanometry (Tymp)">
              <img src="<?php echo e(tm_asset('images/services/tymp.webp')); ?>" alt="Tympanometry (Tymp)" class="tm-diag-service-img" loading="lazy">
            </a>
            <h3 class="tm-diag-service-title">
              <a href="<?php echo e(route('tymp-tympanometry')); ?>" class="text-decoration-none text-reset">Tymp</a>
            </h3>
            <p class="tm-diag-service-desc">Tympanometry is a quick and painless diagnostic test that evaluates</p>
            <a href="<?php echo e(route('tymp-tympanometry')); ?>" class="tm-diag-service-link">
              <span>Learn More</span> <i class="bi bi-chevron-right"></i>
            </a>
          </div>
        </div>
        ...
        <div class="col">
          <div class="tm-diag-service-card">
            <a href="<?php echo e(route('bera-brain-evoked-response-audiometry')); ?>" class="d-block w-100 tm-diag-service-img-wrap" title="Brain Evoked Response Audiometry (BERA)">
              <img src="<?php echo e(tm_asset('images/services/bera.webp')); ?>" alt="BERA Brain Evoked Response Audiometry" class="tm-diag-service-img" loading="lazy">
            </a>
            <h3 class="tm-diag-service-title">
              <a href="<?php echo e(route('bera-brain-evoked-response-audiometry')); ?>" class="text-decoration-none text-reset">BERA</a>
            </h3>
            <p class="tm-diag-service-desc">BERA, or Brain Evoked Response Audiometry, is a non-invasive diagnostic</p>
            <a href="<?php echo e(route('bera-brain-evoked-response-audiometry')); ?>" class="tm-diag-service-link">
              <span>Learn More</span> <i class="bi bi-chevron-right"></i>
            </a>
          </div>
        </div>
        ...
        <div class="col">
          <div class="tm-diag-service-card">
            <a href="<?php echo e(route('oae-oto-acoustic-emission')); ?>" class="d-block w-100 tm-diag-service-img-wrap" title="Oto Acoustic Emissions (OAE)">
              <img src="<?php echo e(tm_asset('images/services/oae.webp')); ?>" alt="OAE Oto Acoustic Emissions" class="tm-diag-service-img" loading="lazy">
            </a>
            <h3 class="tm-diag-service-title">
              <a href="<?php echo e(route('oae-oto-acoustic-emission')); ?>" class="text-decoration-none text-reset">OAE</a>
            </h3>
            <p class="tm-diag-service-desc">Oto Acoustic Emissions (OAE) is a quick, non-invasive test used</p>
            <a href="<?php echo e(route('oae-oto-acoustic-emission')); ?>" class="tm-diag-service-link">
              <span>Learn More</span> <i class="bi bi-chevron-right"></i>
            </a>
          </div>
        </div>
      ...
      <div class="text-center mt-3 d-sm-none">
        <a href="<?php echo e(route('diagnostic-services')); ?>" class="tm-btn tm-btn-outline-navy tm-btn-sm w-100">
    ...
    <div class="container">
      ...
      <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end tm-section-head mb-4 gap-3">
        ...
        <div class="d-flex align-items-center gap-2">
          ...
          <a href="<?php echo e(route('about-us')); ?>" class="tm-btn tm-btn-outline-navy tm-btn-sm">Clinical Profile <i class="bi bi-arrow-right"></i></a>
        </div>
      </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="tm-doctor-card">
            ...
            <div class="tm-doctor-media">
              <img src="<?php echo e(tm_asset('images/doctor-single.png')); ?>" alt="Dr. Ritu Verma - Senior Clinical Audiologist" loading="lazy">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="tm-doctor-card">
            ...
            <!-- Photo Media Frame -->
            <div class="tm-doctor-media">
              <img src="<?php echo e(tm_asset('images/team/team-02.webp')); ?>" alt="Dr. Sumit Kumar Singh - Lead Audiologist & Fitting Specialist" loading="lazy">
              <div class="tm-doctor-media-overlay">
                <div class="tm-doctor-media-top">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="tm-doctor-card">
            ...
            <!-- Photo Media Frame -->
            <div class="tm-doctor-media">
              <img src="<?php echo e(tm_asset('images/team/team-03.webp')); ?>" alt="Dr. Saurabh Mishra - Pediatric Audiologist & Electrophysiologist" loading="lazy">
              <div class="tm-doctor-media-overlay">
                <div class="tm-doctor-media-top">
      ...
      <div class="mt-4 p-3 p-md-4 rounded-4 border bg-light d-flex flex-column flex-md-row align-items-center justify-content-between gap-3 shadow-xs">
        ...
        <div class="d-flex gap-2 text-nowrap">
          <a href="tel:<?php echo e(SITE_PHONE_RAW); ?>" class="tm-btn tm-btn-outline-navy btn-sm">
            <i class="bi bi-telephone-fill me-1"></i> Call <?php echo e(SITE_PHONE); ?>

          </a>
          <a href="https://wa.me/<?php echo e(SITE_WHATSAPP); ?>?text=<?php echo e(urlencode('Hello, I need help selecting the right hearing doctor.')); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-success rounded-pill px-3 d-flex align-items-center gap-1">
  ...
  <section class="tm-luxury-reels-stage border-top border-bottom" id="patientStoriesSection">
    <div class="container position-relative z-2">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4 mb-4">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $patientVideos ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="col">
          <div class="tm-cinematic-card"
               onclick="openYouTubePatientVideo(this)"
               data-youtube-id="<?php echo e($video->youtube_id); ?>"
               data-title="<?php echo e($video->modal_title_text); ?>"
               data-badge="<?php echo e($video->modal_badge_text); ?>"
               data-speaker="<?php echo e($video->speaker); ?>"
               data-location="<?php echo e($video->location); ?>"
               data-desc="<?php echo e($video->modal_description_text); ?>">
            <div class="tm-cinematic-media">
              <img src="<?php echo e($video->thumbnail_url); ?>" alt="<?php echo e($video->title); ?>" class="tm-cinematic-thumb">
              <div class="tm-cinematic-overlay"></div>

              <div class="tm-cinematic-badges">
                <span class="tm-badge-yt"><i class="bi bi-youtube"></i> <?php echo e($video->badge); ?></span>
                <?php if($video->duration): ?>
                <span class="tm-badge-duration"><i class="bi bi-play-circle-fill me-1"></i> <?php echo e($video->duration); ?></span>
                <?php endif; ?>
              </div>
            ...
            <div class="tm-cinematic-body">
              <div class="tm-cinematic-topic"><i class="bi bi-patch-check-fill text-success"></i> <?php echo e($video->topic_label); ?></div>
              <h5 class="tm-cinematic-title"><?php echo e($video->title); ?></h5>
              <div class="tm-cinematic-speaker"><?php echo e($video->card_description); ?></div>

              <div class="tm-cinematic-footer">
                <?php if($video->location): ?>
                <span class="tm-cinematic-loc"><i class="bi bi-geo-alt-fill text-orange"></i> <?php echo e($video->location); ?></span>
                <?php endif; ?>
        ...
        <div class="modal-body p-3 p-md-4">
          ...
          <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center pt-2 border-top border-white-10">
            ...
            <div class="d-flex gap-2">
              <a href="https://wa.me/<?php echo e($siteWhatsApp ?? site_whatsapp()); ?>" target="_blank" class="tm-btn tm-btn-success btn-sm" id="tmYouTubeWaBtn">
                <i class="bi bi-whatsapp me-1"></i> Ask Doctor on WhatsApp
              </a>
              <a href="<?php echo e(route('appointments.create')); ?>" class="tm-btn tm-btn-primary btn-sm">
          ...
          <div class="tm-faq-support-card">
            ...
            <div class="card rounded-3 border bg-light-subtle p-3 mb-3">
              ...
              <div class="d-grid gap-2">
                <a href="https://wa.me/<?php echo e(SITE_WHATSAPP); ?>?text=<?php echo e(urlencode('Hello Doctor, I have a question regarding hearing aids and testing.')); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-success rounded-pill d-flex align-items-center justify-content-center gap-2 py-2 fw-semibold">
                  <i class="bi bi-whatsapp"></i> WhatsApp
                </a>
                <a href="tel:<?php echo e(SITE_PHONE_RAW); ?>" class="tm-btn tm-btn-outline-navy btn-sm justify-content-center py-2">
                  <i class="bi bi-telephone-fill me-1"></i> Call <?php echo e(SITE_PHONE); ?>
    ...
    <div class="container">
      <div class="d-flex flex-column flex-md-row align-items-md-end justify-content-between mb-4 gap-3">
        ...
        <div class="d-none d-md-block">
          <a href="<?php echo e(route('blog.index')); ?>" class="tm-btn tm-btn-outline-navy btn-sm">
        ...
        <div class="col">
          <article class="tm-blog-card shadow-xs">
            <div class="tm-blog-img-wrap">
              <img src="<?php echo e($blog->thumbnail_url); ?>" onerror="this.onerror=null;this.src='<?php echo e(asset('frontend-assets/images/no-product/no-product.png')); ?>';" alt="<?php echo e($blog->title); ?>" loading="lazy">
              <span class="tm-blog-badge tm-blog-badge-orange"><?php echo e($blog->blogCategory?->name ?? 'Hearing Health'); ?></span>
              <span class="tm-blog-read-time"><i class="bi bi-clock me-1"></i> <?php echo e(max(1, (int) ceil(str_word_count(strip_tags($blog->body)) / 200))); ?> min read</span>
            </div>
            <div class="tm-blog-body">
              <div class="tm-blog-meta">
                <span class="tm-blog-meta-item"><i class="bi bi-calendar3 text-orange"></i> <?php echo e(optional($blog->published_at ?? $blog->created_at)->format('M d, Y')); ?></span>
                <span class="tm-blog-meta-item text-secondary">•</span>
                <span class="tm-blog-meta-item"><i class="bi bi-patch-check-fill text-success"></i> <?php echo e($blog->admin?->name ?? SITE_SHORT); ?></span>
              </div>
              <h3 class="tm-blog-title">
                <a href="<?php echo e(route('blog.show', $blog->slug)); ?>" class="stretched-link"><?php echo e($blog->title); ?></a>
              </h3>
              <p class="tm-blog-desc">
                <?php echo e(Str::limit(strip_tags($blog->excerpt ?: $blog->body), 135)); ?>
      ...
      <div class="text-center mt-3 d-md-none">
        <a href="<?php echo e(route('blog.index')); ?>" class="tm-btn tm-btn-outline-navy tm-btn-sm w-100">
          Explore All Insights <i class="bi bi-arrow-right ms-1"></i>
        </a>
      </div>
...
<?php echo $__env->make('site.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\laravel\turtlemaarks\resources\views/site/index.blade.php ENDPATH**/ ?>