...
@section('meta_description', 'Otoacoustic Emission (OAE) cochlear outer hair cell screening in Greater Noida West. Universal newborn screening and industrial noise damage audit.')
        ...
        <div class="col-lg-8 tm-service-main-col">
          ...
          <div class="card rounded-4 border overflow-hidden bg-white shadow-xs mb-4">
            <div style="aspect-ratio: 16/9; background: #F8FAFC; overflow: hidden;">
              <img src="{{ tm_asset('images/services/oae.webp') }}" alt="OAE Otoacoustic Emission Screening" class="w-100 h-100 object-fit-cover">
            </div>
        ...
        <div class="col-lg-4 tm-service-sidebar">
          ...
          <div class="tm-diag-nav-card">
            ...
            <div class="tm-diag-nav-list">
              ...
              <!-- OAE -->
              <a href="{{ route('oae-oto-acoustic-emission') }}" class="tm-diag-nav-item active">
                <div class="tm-diag-nav-item-left">
          ...
          <div class="card rounded-4 border p-4 bg-navy text-white shadow-xs text-center tm-service-assistance-card">
            ...
            <div class="d-grid gap-2">
              ...
              <a href="https://wa.me/{{ $siteWhatsApp ?? site_whatsapp() }}?text={{ rawurlencode('Hi ' . ($siteName ?? site_name()) . ', I would like information regarding OAE (Oto Acoustic Emission) testing.') }}" target="_blank" rel="noopener" class="tm-btn tm-btn-whatsapp tm-btn-sm"><i class="bi bi-whatsapp me-1"></i> WhatsApp Consultation</a>
            </div>
          </div>
