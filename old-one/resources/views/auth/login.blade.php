...
<head>
    <meta charset="UTF-8">
    <title>Login | Hearing Aid Clinic in Noida | Turtle Maarks Hearing Health</title>
...
<body>
    <div class="login-card">
        ...
        <div class="logo-wrapper">
            <img src="{{ asset('assets/images/logo.png') }}" alt="Logo" style="width: 200px; height: auto;" class="login-logo">
