...
<div class="container-fluid p-0">
    <img src="{{asset('assets/images/banners/banner-1.webp')}}" class="img-fluid w-100 d-block" alt="Banner">
</div>
...
<div class="service-area padding-top-115 padding-bottom-90">
    <div class="service-shapes">
        <img src="{{asset('assets/images/ser-vec1.png')}}" alt="" class="vec1 item-animateTwo">
        <img src="{{asset('assets/images/ser-vec2.png')}}" alt="" class="vec2">
    </div>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay='.2s'>
                <div class="single-service">
                    <img src="{{asset('assets/images/services/pta.webp')}}" alt="">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay='.2s'>
                <div class="single-service">
                    <img src="{{asset('assets/images/services/tymp.webp')}}" alt="">
                    <div class="cont-box margin-top-20">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay='.4s'>
                <div class="single-service">
                    <img src="{{asset('assets/images/services/bera.webp')}}" alt="">
                    <div class="cont-box margin-top-20">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay='.6s'>
                <div class="single-service">
                    <img src="{{asset('assets/images/services/oae.webp')}}" alt="">
                    <div class="cont-box margin-top-20">
                ...
                <div class="container highway-barrier">
                    <ul class="highway-lane">
                        <li class="highway-car">
                            <img src="{{asset('assets/images/brand/widex.webp')}}" />
                        </li>
                        <li class="highway-car">
                            <img src="{{asset('assets/images/brand/signia.webp')}}" />
                        </li>
                        <li class="highway-car">
                            <img src="{{asset('assets/images/brand/starkey.webp')}}" />
                        </li>
                        <li class="highway-car">
                            <img src="{{asset('assets/images/brand/resound.webp')}}" />
                        </li>
                        <li class="highway-car">
                            <img src="{{asset('assets/images/brand/phonak.webp')}}" />
                        </li>
                        <li class="highway-car">
                            <img src="{{asset('assets/images/brand/unitron.webp')}}" />
                        </li>
                        <li class="highway-car">
                            <img src="{{asset('assets/images/brand/oticon.webp')}}" />
                        </li>
                        <li class="highway-car">
                            <img src="{{asset('assets/images/brand/earkart.webp')}}" />
                        </li>
                        <li class="highway-car">
                            <img src="{{asset('assets/images/brand/alps-international.webp')}}" />
                        </li>
                        <li class="highway-car">
                            <img src="{{asset('assets/images/brand/widex.webp')}}" />
                        </li>
...
<div class="ht-team-area  padding-top-115 padding-bottom-90">
    <div class="team-shapes">
        ...
        <img src="{{asset('assets/images/color-vec4.png')}}" alt="" class="vec3">
    </div>
    <div class="container">
        ...
        <div class="gallery-wrapper">
            <div class="row port-galleries">
                <div class="col-lg-4 col-md-4 col-12">
                    <a href="{{asset('assets/images/gallery/01.webp')}}" target="_blank">
                        <div class="single-gallery">
                            <img src="{{asset('assets/images/gallery/01.webp')}}" class="img-fluid rounded" alt="">
                            <span><i class="far fa-image"></i></span>
                        </div>
                    </a>
                </div>
                <div class="col-lg-8 col-md-8 col-12"> <a href="{{asset('assets/images/gallery/02.webp')}}" target="_blank">
                        <div class="single-gallery">
                            <img src="{{asset('assets/images/gallery/02.webp')}}" class="img-fluid rounded" alt="">
                            <span><i class="far fa-image"></i></span>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <a href="{{asset('assets/images/gallery/03.webp')}}" target="_blank">
                        <div class="single-gallery">
                            <img class="img-fluid" src="{{asset('assets/images/gallery/03.webp')}}" alt=""> <span><i
                                    class="far fa-image"></i></span>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-4 col-12"> <a href="{{asset('assets/images/gallery/04.webp')}}" target="_blank">
                        <div class="single-gallery">
                            <img class="img-fluid" src="{{asset('assets/images/gallery/04.webp')}}" alt="">
                            <span><i class="far fa-image"></i></span>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-4 col-12"><a href="{{asset('assets/images/gallery/05.webp')}}" target="_blank">
                        <div class="single-gallery">
                            <img class="img-fluid" src="{{asset('assets/images/gallery/05.webp')}}" alt=""> <span><i
                                    class="far fa-image"></i></span>
                        </div>
                    </a>
                </div>
            ...
            <div class="btn-box text-center margin-top-30">
                <a href="{{asset('assets/images/gallery/05.webp')}}" class="btn3" target="_blank">View All Gallery</a>
            </div>
        </div>
    </div>
</div>
...
<div class="testimonial-area padding-top-115 padding-bottom-145">
    <div class="testi-shapes">
        <img src="{{asset('assets/images/fea-vec2.png')}}" alt="" class="vec1 item-bounce">
        <img src="{{asset('assets/images/fea-vec3.png')}}" alt="" class="vec2 item-rotate">
    </div>
    <div class="container">
        <div class="row justify-content-center margin-bottom-25">
            <div class="col-lg-8">
...
<div class="faq-area padding-top-115">
    <div class="faq-shapes">
        <img src="{{asset('assets/images/faq-vec1.png')}}" alt="" class="vec1 item-animateOne">
        <img src="{{asset('assets/images/faq-vec2.png')}}" alt="" class="vec2 wow zoomIn">
    </div>
    <div class="container">
        <div class="row justify-content-center margin-bottom-45">
            <div class="col-lg-8">
        ...
        <div class="row">
            <div class="col-lg-5 col-12">
                <div class="faq-left">
                    <img src="{{asset('assets/images/fea-1.png')}}" class="rounded" alt="">
                </div>
            </div>
