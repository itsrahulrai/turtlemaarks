...
@section('title', 'Thank you - Turtle Maarks Hearing Health')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <nav aria-label="breadcrumb">
                <h2 class="page-title">Thank you
                </h2>
                <ol class="breadcrumb text-center">
                    <li class="breadcrumb-item active" aria-current="page">Thank you! Your booking request has been sent.</li>
                </ol>
                    <a class="btn1" href="{{ url('home') }}">Go to Home</a>
