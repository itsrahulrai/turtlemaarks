...
class OrderPlacedNotification extends Notification implements ShouldQueue
{
    ...
    {
        // NOTE: 'mail' is intentionally excluded here. The customer's order
        // confirmation email is already sent by SendOrderConfirmationEmail
        // (App\Mail\OrderConfirmationMail) — keeping 'mail' in both places
        // sent the customer two separate confirmation emails per order.
        return ['database', SmsChannel::class, WhatsAppChannel::class];
    }
