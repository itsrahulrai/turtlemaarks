  <title>Pages - Nexa Health Consult - Your Smart Healthcare Consultants</title>
  <x-app-layout>
              ...
              <div class="row min-vh-100">
                  ...
                  <main class="col-12 col-md-9 col-lg-10 p-4">
                      ...
                      <div class="card border-0 rounded shadow-sm mb-3">
                          <div class="card-body">
                              <h5 class="card-title fw-bold text-dark">Pages</h5>
                              <nav aria-label="breadcrumb" class="mb-0">
                                  <ol class="breadcrumb mb-0">
                                      ...
                                      <li class="breadcrumb-item active" aria-current="page">
                                          <span class="fw-semibold" style="color:#000;">All Pages</span>
                                      </li>
                                  </ol>
                              </nav>
                          </div>
                      ...
                      <div class="card rounded shadow-sm border-0">
                          <div class="card-header d-flex justify-content-between align-items-center" style="background-color:#1276B7;; color:#fff;">
                              ...
                              <a href="{{ route('admin.pages.create') }}" class="btn btn-sm" style="background-color:#000; color:#fff;">+  New Pages</a>
                          </div>
                                 ...
                                 <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.pages.edit', $page->id) }}" class="btn btn-sm" style="background-color:#000; color:#fff;">Edit</a>
